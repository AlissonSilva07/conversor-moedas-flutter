...
Widget _buildUi(BuildContext context, CurrencyState state) {
  final loadedState = state as CurrencyLoaded;
  final TextEditingController amountController = TextEditingController(text: state.valueFrom.toString());
  final TextEditingController convertedController = TextEditingController(text: state.valueTo.toString());
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 8),
                              Text(
                                '${state.valueFrom} ${state.currencyFrom} = ${state.valueTo} ${state.currencyTo}',
                                style: Theme.of(context).textTheme.bodySmall
                                    ?.copyWith(fontWeight: FontWeight.w700),
                                textAlign: TextAlign.center,
                              ),
